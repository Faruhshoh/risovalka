...
let button_tool = document.getElementById("tool");//конпка для смены инструмента
let button_clear = document.getElementById("clear");//кнопка для очистки холста

//устанавливаем размер холста по размером видимой части элемента canvas
...
//сохранение холстов ввиде картинки
...
//ждём событиt клик по кнопке холста
